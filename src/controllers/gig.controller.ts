...
export class GigController {
    ...
    createGig = async (req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            const gig = await this.gigService.createGig(user._id.toString(), validatedData);
    ...
    getGigs = async (req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            const filters = {
                ...
                instruments: instruments ? (instruments as string).split(",") : undefined,
    ...
    updateGig = async (req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            const gig = await this.gigService.updateGig(user._id.toString(), id, validatedData);
